...
class MLP:
    """
    Multi-Layer Perceptron with high-level Python interface.
    
    Uses C++ implementation for performance-critical operations while providing
    a clean Python API for ease of use.
    """
